...
if os.path.exists('score.txt'):
    ...
    print("hello")
########################################################################################333
jumpy_image=pygame.image.load("pikapika1.png").convert_alpha()
...
winner_img=pygame.image.load("winner1.png").convert_alpha()
winner_img=pygame.transform.scale(winner_img,(120,80))
###########################################
...
class player:
    def __init__(self,x,y):
        self.image=pygame.transform.scale(jumpy_image,(80,55))
        self.width = 25
        self.height = 40
...
while run:
    ...
    if game_over==False:
        ...
        pygame.draw.line(screen, white, (0, score - highscore + scrool_thres), (SCREEN_WIDTH, score - highscore + scrool_thres), 3)
        screen.blit(winner_img,(SCREEN_WIDTH - 130, score - highscore + scrool_thres))
        draw_text('HIGH SCORE', font_again, white, 20, score - highscore + scrool_thres)
